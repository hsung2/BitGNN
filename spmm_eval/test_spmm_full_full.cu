...
#elif OUTUNIT == 2
        spmm4_full_full_2_1024<<<grid2, 1024>>>(tA, fB, fC, bsrRowPtr, bsrColInd, nblockrows, nBcols);
#elif OUTUNIT == 4
        spmm4_full_full_4_1024<<<grid3, 1024>>>(tA, fB, fC, bsrRowPtr, bsrColInd, nblockrows, nBcols);
#else // OUTUNIT == 8
        spmm4_full_full_8_1024<<<grid4, 1024>>>(tA, fB, fC, bsrRowPtr, bsrColInd, nblockrows, nBcols);
#endif
